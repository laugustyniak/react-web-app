                ...
                <Card className="w-full">
                  <div className="p-4 w-full">
                    {isEditing && editValues ? (
                      ...
                      <>
                        <h4 className="text-lg font-semibold mb-2">{prod.product_name}</h4>
                        ...
                        <div className="flex gap-2 mt-2">
                          ...
                          <Button size="sm" variant="default" onClick={() => onSearchWithAI(idx, `${prod.product_name} ${prod.description_in_english}`)} disabled={isSearchingByIdx[idx]}>
