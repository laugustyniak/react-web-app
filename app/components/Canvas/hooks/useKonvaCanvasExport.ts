// Canvas/hooks/useKonvaCanvasExport.ts
...
export function useKonvaCanvasExport(
    images: CanvasImage[],
    ...
    const saveAsImage = async () => {
        ...
        try {
            ...
            // Use Konva's built-in toDataURL method for better quality
            ...
            if (selectedImage) {
                setImages(images.map(img => ({
                    ...img,
                    selected: img.id === selectedImage.id
                })));
            }
